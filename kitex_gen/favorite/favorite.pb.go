...
type DouyinFavoriteActionRequest struct {
	...
	StatusCode int32  `protobuf:"varint,3,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 1-点赞，2-取消点赞
}
...
func (x *DouyinFavoriteActionRequest) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x22, 0xfa, 0x01, 0x0a, 0x05, 0x56,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e,
	...
	0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x22, 0xe1, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	...
	0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x72, 0x0a, 0x1e, 0x64,
	...
	0x6e, 0x22, 0x8f, 0x01, 0x0a, 0x1d, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76,
	...
	0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	0x74, 0x65, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x4c,
	0x69, 0x73, 0x74, 0x32, 0xdd, 0x01, 0x0a, 0x0f, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x67, 0x0a, 0x0e, 0x46, 0x61, 0x76, 0x6f, 0x72,
	0x69, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x28, 0x2e, 0x66, 0x61, 0x76, 0x6f,
	...
	0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x64,
	0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x61,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x12, 0x61, 0x0a, 0x0c, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74,
	0x12, 0x26, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x64, 0x6f, 0x75, 0x79,
	0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74,
	0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72,
	...
	0x65, 0x22, 0x00, 0x42, 0x23, 0x5a, 0x21, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x2d, 0x62, 0x61,
...
var file_favorite_proto_goTypes = []interface{}{
	...
	(*DouyinFavoriteListRequest)(nil),    // 4: favorite.douyin_favorite_list_request
	(*DouyinFavoriteListResponse)(nil),   // 5: favorite.douyin_favorite_list_response
}
var file_favorite_proto_depIdxs = []int32{
	1, // 0: favorite.Video.author:type_name -> favorite.User
	0, // 1: favorite.douyin_favorite_list_response.video_list:type_name -> favorite.Video
	2, // 2: favorite.FavoriteService.FavoriteAction:input_type -> favorite.douyin_favorite_action_request
	4, // 3: favorite.FavoriteService.FavoriteList:input_type -> favorite.douyin_favorite_list_request
	3, // 4: favorite.FavoriteService.FavoriteAction:output_type -> favorite.douyin_favorite_action_response
	5, // 5: favorite.FavoriteService.FavoriteList:output_type -> favorite.douyin_favorite_list_response
