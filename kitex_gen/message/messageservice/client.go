...
type Client interface {
	...
	MessageActioin(ctx context.Context, Req *message.DouyinRelationActionRequest, callOptions ...callopt.Option) (r *message.DouyinRelationActionResponse, err error)
}
...
func (p *kMessageServiceClient) MessageActioin(ctx context.Context, Req *message.DouyinRelationActionRequest, callOptions ...callopt.Option) (r *message.DouyinRelationActionResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.MessageActioin(ctx, Req)
}
