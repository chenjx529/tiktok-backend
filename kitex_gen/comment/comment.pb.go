...
type DouyinCommentActionRequest struct {
	...
	StatusCode  int32  `protobuf:"varint,3,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`   // 1-发布评论，2-删除评论
...
func (x *DouyinCommentActionRequest) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
var file_comment_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x65, 0x22, 0x4e, 0x0a, 0x1b, 0x64, 0x6f,
...
var file_comment_proto_goTypes = []interface{}{
	...
	(*DouyinCommentActionRequest)(nil),  // 1: comment.douyin_comment_action_request
	(*DouyinCommentActionResponse)(nil), // 2: comment.douyin_comment_action_response
...
var file_comment_proto_depIdxs = []int32{
	3, // 0: comment.douyin_comment_action_response.comment:type_name -> comment.Comment
	0, // 1: comment.Comment.user:type_name -> comment.User
	3, // 2: comment.douyin_comment_list_response.comment_list:type_name -> comment.Comment
	1, // 3: comment.CommentService.CommentAction:input_type -> comment.douyin_comment_action_request
	4, // 4: comment.CommentService.CommentList:input_type -> comment.douyin_comment_list_request
	2, // 5: comment.CommentService.CommentAction:output_type -> comment.douyin_comment_action_response
